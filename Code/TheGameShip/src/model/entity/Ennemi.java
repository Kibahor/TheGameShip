...
public class Ennemi extends Entity implements IMovable {
    ...
    public Ennemi(String name, String sprite, double height, double width) {
        super(name, sprite, EType.Ennemy, height, width, 5, 1000, 300);
        setSpeedX(5);
        setSpeedY(5);
    }

    public Ennemi(String name, String sprite, double height, double width, double hp, double x, double y, float speedX, float speedY) {
