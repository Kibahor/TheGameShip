...
public class Entity extends Componement implements IEntity {
    ...
    @Override
    public void addComponement(Componement c) {
        componements.put(c.getType(), c);
    }

    @Override
    public Componement getComponement(EComponementType type) {
        return componements.get(type);
    }

    @Override
    public boolean isTypeOf(EComponementType type) {
    ...
    @Override
    public boolean isTypeOf(EEntityType type) {
